...
@TeleOp(name = "JerseyGirl_TeleDriveHandler_Test_Shooter", group = "TeleOpMode")
@Disabled
public class JerseyGirl_TeleDriveHandler_Test_Shooter extends TeleDrive {


    private ElapsedTime runtime = new ElapsedTime(ElapsedTime.Resolution.MILLISECONDS);
    public DcMotor shooterTest   = null;
...
*/
        ...
        shooterTest  = hardwareMap.dcMotor.get("leftFront");
...
*/
        shooterTest.setDirection(DcMotor.Direction.REVERSE);

...
@TeleOp(name = "JerseyGirl_TeleDriveHandler_Test_Wheels", group = "TeleOpMode")
@Disabled
public class JerseyGirl_TeleDriveHandler_Test_Wheels extends TeleDrive {


    private ElapsedTime runtime = new ElapsedTime(ElapsedTime.Resolution.MILLISECONDS);
    public DcMotor wheelTest   = null;
...
*/
        ...
        wheelTest  = hardwareMap.dcMotor.get("wheelTest");
        
        wheelTest.setDirection(DcMotor.Direction.REVERSE);
